...
Language is rapidly evolving, and the usage of words changes over time. <!-- ref -->
Words assimilate new meanings or associations.
Some efforts have been made to study semantic change using biomedical text <!--refs!-->; however, no such work has examined the changes evident in both pre-publication peer reviewed and preprinted biomedical text.
