...
We examined scientific writing, both preprint and pre-publication peer-reviewed, to identify terms that have changed and examine their use.
...
We developed an approach to evaluating semantic shift accounted for both intra- and inter-year variability that integrated multiple models.
...
The consistent change-points between pre-publication peer-reviewed and preprinted text were largely related to to the COVID-19 pandemic.
